        ...
        <div className="lg:flex lg:flex-row-reverse md:flex-col mb-44 md:mb-[280px] lg:-mb-[120px] 2xl:-mb-[320px]">
            ...
            <div className='2xl:px-20 flex flex-col w-full max-h-[750px] item-center justify-center gap-7 xl:px-0 xl:pl-10 lg:pl-7 lg:text-start md:text-center px-5'>
                <div className="flex flex-col gap-1">
                    <h1 className='font-["otomanopee-one"] text-[#131313] 2xl:text-[50px] xl:text-[48px] lg:text-[38px] md:text-[34px] text-[28px]'>SECURING YOUR WORLD</h1>
                    <h1 className='font-["otomanopee-one"] text-[#131313] 2xl:text-[50px] xl:text-[48px] lg:text-[38px] md:text-[34px] text-[28px]'>ONE STEP AHEAD</h1>
                </div>
