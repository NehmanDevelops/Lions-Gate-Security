...
const HomeCertificate = () => {
    return (
        <>
            <div className="w-screen flex flex-col mt-[110px] md:mt-[90px] xl:mt-[192px] gap-12 xl:gap-20 px-5 items-center bg-gradient-to-b from-[#ECECEC] via-[#B099E4]/50 to-[#ECECEC]">
